...
namespace HelloCS
{
    class Program
    {
        ...
        //целое число означает отрицательное или положительное целое число, включая 0
        ...
        double anotherRealNumber = 2.3; //литера типа double
            ...
            // проверьте, что три переменные имеют одинаковое значение, оба оператора выводят true
            ...
            if (a + b == 0.3)
            {
                Console.WriteLine($"{a} + {b} равно 0.3");
            }
            else
            {
